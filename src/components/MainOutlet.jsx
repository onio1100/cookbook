            ...
            <nav className={"nav " + (nav ? "nav--big" : "nav--small")}>
                ...
                <div className={"menu-background " + (nav ? "menu-background--big" : "menu-background--small")}>
                    <ul className={"menu " + (nav ? "menu--big" : "menu--small")}>
                        <li className={"menu-element menu-element--search " + (nav ? "menu-element--no-border" : "")}>
                            <Link to="/search" className="menu-element__link">SEARCH</Link>
                        </li>
                        <li className="menu-element">
                            <Link to="/home" className="menu-element__link">HOME</Link>
                        </li>
                        <li className="menu-element">
                            <Link to="info" className="menu-element__link">INFO</Link>
                        </li>
